...
export default function Project() {
  const projects = [
    ...
    },
    {
      title: "NIBBLES SHOP",
      description:
        '"Delicious bites crafted to satisfy every craving."',
      tech: "SHOPIFY",
      image: b,
      link: "https://thenibbles.shop/",
    },
    {
      title: "ECLAT MAISON",
      description:
        '“Curating timeless fragrances and elegant essentials for refined everyday living.”',
      tech: "SHOPIFY",
      image: c,
      link: "https://www.eclatmaison.in/",
    },
    {
      title: "DRAPES CORNER",
      description:
    ...
    {
      title: "BRANDING NEXUS",
      description:
        '“Building bold brands that connect, inspire, and grow.”',
      tech: "WORDPRESS",
      image: e,
      link: " https://brandingnexus.in/brand-that-converts/",
    },
    {
    ...
    },
    {
      title: "25 SOUTH ",
      description:
        '"A high-end property showcase website designed with elegant layouts, immersive visuals, and responsive performance."',
      tech: "WORDPRESS",
      image: g,
      link: "https://25south-prabhadevi.com/",
    },
    {
      title: "VINODHA",
      description:
